...
Monitor individual user actions to quickly spot unusual patterns and prevent abuse.
...
Control the flow of requests to prevent misuse that could rack up your bill, helping you avoid unexpected charges.
